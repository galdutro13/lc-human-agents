...
from source.simulation_config import ConfigValidationError, carregar_config_v44
...
class TestLoaderV44(unittest.TestCase):
    def test_carregar_config_v44_valido(self):
        config = carregar_config_v44(V44_PATH)

        self.assertEqual(config["versao"], "4.4")
